...
import domain.*;
import domain.lojas.Bijuteria;
import domain.lojas.Cosmetico;
import domain.lojas.Informatica;
import domain.lojas.Vestuario;
...
public class ValidadorEtapa4 {
    ...
    public static void main(String[] args) {
        ...
        //Criação da instância
//		Alimentacao lojaAlimentacao = new Alimentacao("Loja Alimentação", 10, 2100, e1, d1, d1, 10); // ISSO AQUI NEM EXISTE
